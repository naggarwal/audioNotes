 ...
 */
export async function createRecording(data: Omit<Recording, 'id' | 'created_at' | 'updated_at'>, client?: any) {
  console.log(`[createRecording] Creating recording with ${client ? 'provided auth client' : 'default supabase client'}`);
